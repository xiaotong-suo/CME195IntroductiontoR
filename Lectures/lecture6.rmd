...
You start with blank canvas, and build things from there. We will start with using just the 'plot' function first. Then we use annotation functions to modify our plots, such as adding text, 
lines, points, axis, titles, etc.
